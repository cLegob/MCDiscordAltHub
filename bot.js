...
async function handleDiscordMessage(message) {
    try {
            ...
            switch (command) {
                ...
                case 'reconnect':
                    if (connected) {
                        ...
                        reconnectMinecraftBot(); // Triggers onMinecraftEnd to reconnect
                    } else {
        ...
        toDiscordChat('***:x:Error handling Discord message:***\n\`\`\`', error, '\`\`\`');
    }
}
...
function reconnectMinecraftBot() {
    ...
    botMaker(); // Call the botMaker function to attempt reconnection
}
